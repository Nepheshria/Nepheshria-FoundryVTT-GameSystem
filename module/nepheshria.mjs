...
import { NepheshriaActorSheet } from "./sheets/actor-sheet.mjs";
import { NepheshriaItemSheet } from "./sheets/item-sheet.mjs";
...
async function createItemMacro(data, slot) {
  ...
  const command = `game.nepheshria.rollItemMacro("${data.uuid}");`;
  ...
  if (!macro) {
    macro = await Macro.create({
      ...
      img: item.img,
      command: command,
      flags: { "nepheshria.itemMacro": true }
    });
  }
